    ...
    return (
        <>
            <div className="textGalleryTop">
                <blockquote className="txt_gallery_summary hiderx">{txtGallery}</blockquote>
            </div>
                ...
                <Image.PreviewGroup>
                    <div className="container">
                        {imgArrObj.map((a) => {
                            return (
                                <div
                                    className={`img ${a.imgClass} hiderx`}
                                    style={{
                        ...
                        <div>
                            <div className="container_mobile">
                                {imgArrObj.slice(0, 6).map((a) => {
                                    return (
                                        <div
                                            className={`img mob ${a.imgClass} hiderx`}
                                            style={{
                                                backgroundImage: `url(${a.imgSrc})`,
                                                backgroundSize: "cover",
                                                backgroundPosition: "center",
            ...
            <div>
                <div className="text_div top-to-bottom">
                    <blockquote
                        style={{
                            fontStyle: "italic",
                            paddingLeft: "1rem",
